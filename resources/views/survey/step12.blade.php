{{-- resources/views/survey/step12.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="utf-8">
    <title>Survei Kepuasan Masyarakat – Langkah 12</title>
        ...
        <div class="max-w-5xl mx-auto mt-8 mb-12 px-4">
            ...
            <section class="mt-6 flex justify-center">
                <div class="w-full max-w-4xl bg-[#E8F0FB] rounded-[10px] border border-[#D0D9EE] px-6 md:px-10 py-8">
                    ...
                    <form method="POST" action="{{ route('survey.step12.post') }}">
                        @csrf
