...
<head>
    <meta charset="UTF-8">
    <title>Laporan IKM {{ $opdNama }}</title>
    <style>
...
<body>
    ...
    <h3 class="text-center">Laporan Indeks Kepuasan Masyarakat</h3>
    <div class="subtitle"><strong>OPD:</strong> {{ $opdNama }}</div>

    {{-- Distribusi Responden --}}
    <h4>Distribusi Responden Pelayanan Publik</h4>
    <table>
        <thead>
            <tr>
                <th>Karakteristik</th>
    ...
    <h4>Nilai Rata-Rata (NRR) Unsur Pelayanan Publik</h4>
    <table>
        <thead>
            <tr>
                <th>No.</th>
